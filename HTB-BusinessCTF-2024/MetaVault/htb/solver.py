...
if __name__ == "__main__":
    ...
    ipfs = requests.get("https://gateway.pinata.cloud/ipfs/QmX9L9Q9QkM3ytQ1Wk3jKAqNDXYhK8RFQHcfq8QXyfffkN").json()
    print(f"\n[*] IPFS: {ipfs}")
    secret = ipfs['output']['devdoc']['stateVariables']['VAULT_SECRET_K256']['details'].split(' ')[2]
    print(f"\n[*] Secret: {secret}")
